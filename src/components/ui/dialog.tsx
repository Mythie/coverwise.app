...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-orange-100 dark:focus:ring-orange-400 dark:focus:ring-offset-orange-900 dark:data-[state=open]:bg-slate-800">
        <X className="h-4 w-4" />
